...
-- --------------------------------------------------------
-- Host:                         127.0.0.1
-- VersiÃ³n del servidor:         10.1.32-MariaDB - mariadb.org binary distribution
-- SO del servidor:              Win32
-- HeidiSQL VersiÃ³n:             9.5.0.5196
-- --------------------------------------------------------
...
INSERT INTO `producto` (`id_producto`, `nombre`, `foto`, `tipo`, `cantidad_minima`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	...
	(16, 'vino aÃ±ejo', '', 2, 10, 1, 20000, 'nose', 'Activo');
...
--Error de sintaxis: Sintaxis incorrecta cerca de `.
---- --------------------------------------------------------
---- Host:                         127.0.0.1
---- VersiÃ³n del servidor:         10.1.32-MariaDB - mariadb.org binary distribution
---- SO del servidor:              Win32
